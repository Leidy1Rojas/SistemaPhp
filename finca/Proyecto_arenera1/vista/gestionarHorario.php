...
?>
<?php require ("../Modelo/Horario.php") ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <section class="content">
      <section class="content">
       <div class="title_left">
                        <h3>Horario <small style="color: black">Administrar</small></h3>
                    </div>
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php
                                        $arrEspecialidades = Horario::getAll();
                                        foreach ($arrEspecialidades as $especialidad){
                                    ?>
                                        <tr>
                                            <td><?php echo $especialidad->getJornada(); ?></td>
                                            <td><?php echo $especialidad->getHoraInicio(); ?></td>
                                            <td><?php echo $especialidad->getHoraFinal(); ?></td>
                                            <td>
 <a href="Editarpedidos.php?id=<?php echo $especialidad->getidHorario(); ?>
