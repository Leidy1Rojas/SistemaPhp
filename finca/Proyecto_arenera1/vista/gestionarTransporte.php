    ...
    <section class="content">
      <section class="content">
       <div class="title_left">
                        <h3>Transporte <small style="color: black">Administrar</small></h3>
                    </div>
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
                ...
                <?php
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $especialidad->getDueno(); ?></td>
                                            <td><?php echo $especialidad->getidCedula(); ?></td>
                                            <td>
 <a href="editarTransporte.php?id=<?php echo $especialidad->getidTransporte(); ?>
