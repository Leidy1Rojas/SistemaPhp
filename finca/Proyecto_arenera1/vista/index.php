...
<div class="wrapper">
  ...
  <div style="background-image: url('dist/img/fondo.jpg');" class="content-wrapper">
    ...
    <section class="content">
        ...
        <form id="frmLoginn" name="frmLoginn" class="form-horizontal form-label-left" method="post" action="../Controlador/ClientesController.php?action=Login">

            <p style="color: white">Ingrese toda la informacion relacionada con la <code>session Cliente</code>
            </p>
