...
?>
<?php require ("../Modelo/Salarios.php") ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <section class="content">
      <section class="content">
       <div class="title_left">
                        <h3>Salarios <small style="color: black">Administrar</small></h3>
                    </div>
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php
                                        $arrEspecialidades = Salarios::getAll();
                                        foreach ($arrEspecialidades as $especialidad){
                                    ?>
                                        <tr>
                                            <td><?php echo $especialidad->getSalarios(); ?></td>
                                            <td><?php echo $especialidad->getTipos(); ?></td>

                                            <td>
 <a href="editarSalarios.php?id=<?php echo $especialidad->getidSalarios(); ?>
